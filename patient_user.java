 ...
 * @author hiram
 */
public class patient_user extends javax.swing.JFrame {

    /**
     * Creates new form patient_user
     */
    public patient_user() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\hiram\\OneDrive\\Desktop\\logo221.png")); // NOI18N
        ...
        jLabel4.setText("Re-eneter password");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         try{
            ...
            String sqlsql = "select pid from PATIENT_ADD";
            ...
            if(s3.equals(s4)){
                ...
                while(rs1.next()== true)
                {
                    ...
                    if(s2.equals(p))
                    {
                        ...
                        String sq = "INSERT INTO PATIENTUSER VALUES('"+s2+"','"+s3+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(patient_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new patient_user().setVisible(true);
            }
        });
    }
